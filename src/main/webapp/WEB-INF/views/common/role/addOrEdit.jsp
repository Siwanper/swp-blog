...
<body>
    ...
    <div id="toolbar" class="toolbar" style="background: #F5F5F5" align="left">
        <button id="save-btn" class="waves-effect btn btn-success btn-sm" type="button" style="margin-left: 10px" href="javascript:;"><i class="zmdi zmdi-save"></i>保存</button>
        <button id="resource-btn" class="waves-effect btn btn-info btn-sm" type="button" style="margin-left: 10px" href="javascript:;"><i class="zmdi zmdi-save"></i>菜单资源</button>
    </div>
    <form id="dataForm" method="post">
        <div class="container col-xs-11" style="margin-top: 30px; margin-left: 50px;">
            <div class="row" style="margin-top: 10px; margin-bottom: 10px">
                ...
                <div class="col-xs-7">
                    <input id="roleName" class="form-control" name="roleName" type="text" value="${role.roleName}" placeholder="角色树显示的名称（必填）"/>
                </div>
            </div>
            <div class="row" style="margin-top: 10px; margin-bottom: 10px">
                <div class="col-xs-4 text-left" style="background: #E6E6F2; line-height: 26px; vertical-align: middle" >
                ...
                <div class="col-xs-7">
                    <input id="roleIndex" class="form-control" name="roleIndex" type="text" value="${role.roleIndex}" placeholder="整数，按从小到大顺序排列"/>
                </div>
            </div>
            <div class="row" style="margin-top: 10px; margin-bottom: 10px">
                <div class="col-xs-4 text-left" style="background: #E6E6F2; line-height: 26px; vertical-align: middle" >
