...
<head>
    ...
    <title>菜单资源添加修改页</title>
</head>
<body>
    <div id="toolbar" align="left" style="background: #F5F5F5; width: 100%">
        <a id="save-btn" class="waves-effect btn btn-success btn-sm" style="margin-left: 10px" href="javascript:;">
    ...
    <form id="dataForm" method="post">
        ...
        <div class="container col-xs-11" style="margin-top: 30px; margin-left: 50px; display: table;">
            ...
            <div class="row" style="margin-top: 10px ; margin-bottom: 10px;">
                <div class="col-xs-4 text-left" style="background: #FFEEDD; line-height: 26px; vertical-align: middle;">
                    <label style="margin-top: 5px; font-size: 14px; color:grey">菜单名称</label>
                </div>
                <div class="col-xs-7">
                    <div class="form-group">
                        <input id="menuName" class="form-control" type="text" name="menuName" value="${menu.menuName}" placeholder="菜单树显示名称(必填)"/>
                    </div>
                </div>
            </div>
            ...
            <div class="row" style="margin-top: 10px ; margin-bottom: 10px;">
                ...
                <div class="col-xs-7">
                    <div class="form-group">
                        <input id="menuDescribe" class="form-control" type="text" name="menuDescribe" value="${menu.menuDescribe}" placeholder="一句话来描述作用"/>
                    </div>
                </div>
            </div>
            ...
            <div class="row" style="margin-top: 10px ; margin-bottom: 10px;">
                ...
                <div class="col-xs-7">
                    <div class="form-group">
                        <input id="menuUrl" class="form-control" type="text" name="menuUrl" value="${menu.menuUrl}" placeholder="示例：/commons/initalize"/>
                    </div>
                </div>
            </div>
            ...
            <div class="row" style="margin-top: 10px ; margin-bottom: 10px;">
                ...
                <div class="col-xs-7">
                    <div class="form-group">
                        <input id="menuIndex" class="form-control" type="text" name="menuIndex" value="${menu.menuIndex}" placeholder="整数，按从小到大顺序排列"/>
                    </div>
                </div>
            </div>
            ...
            <div class="row" style="margin-top: 10px ; margin-bottom: 10px;">
                <div class="col-xs-4 text-left" style="background: #FFEEDD; line-height: 26px; vertical-align: middle;">
                    <label style="margin-top: 5px; font-size: 14px; color:grey">域级别</label>
                </div>
                <div class="col-xs-7">
                    <div class="form-group">
    ...
    $(function () {
        ...
        $("#save-btn").click(function () {
            ...
            if (bv.isValid()) {
                ...
                $.post("${pageContext.request.contextPath}/commons/menu/save",formData,function (data) {
                    if ("0" == data.status) {
                        parent.menuNodeRefresh();
                    }else  {
                        parent.menuParentNodeRefresh();
                    }
                    $.alert(data.msg);
                })
            }
